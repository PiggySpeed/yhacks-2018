package com.hacks.yale.yhacks_2018.camera;
...
public class CameraSourcePreview2 extends ViewGroup {
    ...
    public CameraSourcePreview2(Context context) {
        super(context);
    ...
    private void start(CameraSource2 camera2Source) throws IOException {
    ...
    public void start(CameraSource2 camera2Source, GraphicOverlay overlay) throws IOException {
        mOverlay = overlay;
        start(camera2Source);
    }
